...
#OPTIONS="${OPTIONS} -DNLC_VERSION=2.2.0 -DMPI_VERSION=2.13.0"
OPTIONS="${OPTIONS} -DSXAT_MPI_LIBRARY_PATH=/opt/nec/ve/mpi/2.13.0"
...
if [ "$WITH_VESOLVER" == "true" ]; then
    ...
    OPTIONS="${OPTIONS} -DCMAKE_TOOLCHAIN_FILE=../elmerfem/cmake/Toolchains/Elmer-SXAT-vesolver.cmake"
